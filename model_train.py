...
model = Sequential()
model.add(Embedding(total_words_len, 64)) # 임베딩 벡터 차원 128
model.add(LSTM(128))
...
#ckpoint = ModelCheckpoint('.\\model' + '\\삼성전자\\' + 'model.h5', monitor = 'val_accuracy', mode = 'max',verbose = 1, save_best_only = True)
