# stopwords data '불용어 사전(Extend).csv' from https://www.ranks.nl/stopwords/korean
...
df1 = pd.read_csv('../훈련데이터(NSMC&Headline)/삼성전자 기사 헤드라인.csv', encoding ='UTF-8-SIG')
df2 = pd.read_csv('../훈련데이터(NSMC&Headline)/LG전자 기사 헤드라인.csv', encoding ='UTF-8-SIG')
df3 = pd.read_csv('../훈련데이터(NSMC&Headline)/현대자동차 기사 헤드라인.csv', encoding ='UTF-8-SIG')
